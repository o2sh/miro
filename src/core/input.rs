...
use crate::core::escape::csi::MouseReport;
use crate::core::escape::parser::Parser;
use crate::core::escape::{Action, CSI};
use crate::core::keymap::{Found, KeyMap};
...
impl InputParser {
    ...
    fn dispatch_callback<F: FnMut(InputEvent)>(&mut self, mut callback: F, event: InputEvent) {
        match (self.state, event) {
            (
                InputState::Normal,
                InputEvent::Key(KeyEvent { key: KeyCode::InternalPasteStart, .. }),
            ) => {
            ...
            (InputState::EscapeMaybeAlt, InputEvent::Key(KeyEvent { key, modifiers })) => {
                ...
                callback(InputEvent::Key(KeyEvent { key, modifiers: modifiers | Modifiers::ALT }));
            }
...
mod test {
    ...
    fn simple() {
        ...
        assert_eq!(
            vec![
                InputEvent::Key(KeyEvent { modifiers: Modifiers::NONE, key: KeyCode::Char('h') }),
                InputEvent::Key(KeyEvent { modifiers: Modifiers::NONE, key: KeyCode::Char('e') }),
                InputEvent::Key(KeyEvent { modifiers: Modifiers::NONE, key: KeyCode::Char('l') }),
                InputEvent::Key(KeyEvent { modifiers: Modifiers::NONE, key: KeyCode::Char('l') }),
                InputEvent::Key(KeyEvent { modifiers: Modifiers::NONE, key: KeyCode::Char('o') }),
            ],
            inputs
        );
    }
    ...
    fn control_characters() {
        ...
        assert_eq!(
            vec![
                InputEvent::Key(KeyEvent { modifiers: Modifiers::CTRL, key: KeyCode::Char('C') }),
                InputEvent::Key(KeyEvent { modifiers: Modifiers::ALT, key: KeyCode::Char('J') }),
                InputEvent::Key(KeyEvent { modifiers: Modifiers::NONE, key: KeyCode::Delete }),
            ],
            inputs
        );
    }
    ...
    fn partial_ambig() {
        ...
        assert_eq!(
            vec![InputEvent::Key(KeyEvent { key: KeyCode::Escape, modifiers: Modifiers::NONE })],
        ...
        assert_eq!(
            vec![
                InputEvent::Key(KeyEvent { key: KeyCode::Escape, modifiers: Modifiers::NONE }),
                InputEvent::Key(KeyEvent { modifiers: Modifiers::NONE, key: KeyCode::Char('[') }),
